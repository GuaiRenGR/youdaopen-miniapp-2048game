...
<textarea> 组件用来创建接收用户输入字符的多行输入组件。 <textarea> 组件的工作方式目前只支持 普通文本，<font style="color:#f5222d;">暂不支持</font>比如 url，email，tel 等。

**<font style="color:rgb(64, 64, 64);">基本用法</font>**<font style="color:rgb(64, 64, 64);"></font>
...
> 更新: 2022-08-15 15:48:25  
> 原文: <https://www.yuque.com/wcye0k/haasui/ug87rx>