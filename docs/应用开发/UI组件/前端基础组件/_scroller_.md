...
![1646035269889-60784e7e-d0a2-44eb-9d0c-ea8cb78a0d72.gif](./img/7cK5CR4sp6epP6BE/1646035269889-60784e7e-d0a2-44eb-9d0c-ea8cb78a0d72-614198.gif)
...
* loadmore，改事件在滑动触底的时候触发，用于增量更新数据。
  * 如果在切换数据后，内容变稍后，会使得该事件不会触发，此时需要调用组件的resetLoadmore�方法
...
功能：在使用loadmore的过程中，因为切换数据导致scroller内容变短后，需要使用该方法来重置loadmore的内部状态，使得再次触底时可以正常触发loadmore 事件。


> 更新: 2023-10-17 16:55:23  
> 原文: <https://www.yuque.com/wcye0k/haasui/pxy0d4>