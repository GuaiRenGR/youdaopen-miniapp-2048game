...
![1646041210084-d5ea90a3-a8fc-49a4-abb8-aa448137c9e7.gif](./img/xBsYao3d7rXN2IRM/1646041210084-d5ea90a3-a8fc-49a4-abb8-aa448137c9e7-339318.gif)
...
`<input>` 组件用来创建接收用户输入字符的输入组件。 `<input>` 组件的工作方式目前只支持 `password`或普通文本，<font style="color:#F5222D;">暂不支持</font>比如 `url`，`email`，`tel` 等。
...
> 更新: 2023-12-19 14:44:18  
> 原文: <https://www.yuque.com/wcye0k/haasui/ghb8w5>