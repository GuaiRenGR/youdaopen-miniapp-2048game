...
3.\*\*<font style="color:#DF2A3F;">tip：</font>****使用全局事件功能，需要****<font style="color:#DF2A3F;">严格遵循 on/off 流程，</font>****否则会存在****<font style="color:#DF2A3F;">内存泄漏</font>\*\***问题**
...
<font style="color:#F5222D;">如果callback不传或者传空值(null,undefined),则取消当前应用所有eventName对应的监听,如:</font>
...
应用中可手动触发全局事件.通过javascript手动触发的全局事件<font style="color:#F5222D;">仅限作用于当前应用,不会被其他应用收到.</font>
...
底层可通过事件接口触发全局事件,<font style="color:#F5222D;">底层触发的全局事件所有应用都可监听收到.</font>
...
> 更新: 2023-05-26 11:19:39  
> 原文: <https://www.yuque.com/wcye0k/haasui/qqvb7r>