...
Dom和组件事件遵循Vue标准,可参考Vue事件文档:[事件处理](https://v2.cn.vuejs.org/v2/guide/events.html),[组件自定义事件](https://v2.cn.vuejs.org/v2/guide/components-custom-events.html)
...
> 更新: 2023-08-28 17:22:35  
> 原文: <https://www.yuque.com/wcye0k/haasui/sulw4u>