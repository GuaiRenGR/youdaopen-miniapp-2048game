...
<font style="color:#F5222D;">1.暂时不支持多个动画属性分开设置.如果有类似的需求,需要写成两个css样式.</font>

<font style="color:#F5222D;">2.transition不支持多个属性连写.</font>
...
> 更新: 2022-06-30 21:45:10  
> 原文: <https://www.yuque.com/wcye0k/haasui/eyem3s>