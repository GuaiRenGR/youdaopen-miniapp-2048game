...
布局模型基于 CSS `[Flexbox](http://www.w3.org/TR/css3-flexbox/)`，以便所有页面元素的排版能够一致可预测，同时页面布局能适应各种设备或者屏幕尺寸。Flexbox 包含 flex 容器和 flex 成员项。如果一个 元素可以容纳其他元素，那么它就成为 flex 容器。

<font style="color:#F5222D;">文档中未说明的 flexbox 属性均不支持：如 </font><code><font style="color:#F5222D;">order</font></code><font style="color:#F5222D;">、</font><code><font style="color:#F5222D;">flex-flow</font></code><font style="color:#F5222D;"> 等。</font>

## Flex 容器

<font style="color:#F5222D;">Flexbox 是默认且唯一的布局模型，所以你不需要手动为元素添加 </font><code><font style="color:#F5222D;">display: flex;</font></code><font style="color:#F5222D;"> 属性。</font>
...
![1644922071164-db7e1a24-d94c-45e1-9466-32458fb7da0e.svg](./img/YOOxdqEjvSswXUTr/1644922071164-db7e1a24-d94c-45e1-9466-32458fb7da0e-338333.svg)
...
![1644922071656-a19a0826-a578-44ce-a3bb-7eb009840f44.png](./img/YOOxdqEjvSswXUTr/1644922071656-a19a0826-a578-44ce-a3bb-7eb009840f44-936028.png)
...
* `flex {number}`：值为 number 类型。\*\*该属性不支持 \*\*<code>**flex: <flex-grow> | <flex-shrink> | <'flex-basis>**</code> 的简写。
...
> 更新: 2022-02-15 18:58:44  
> 原文: <https://www.yuque.com/wcye0k/haasui/ofrd1k>