...
| cubic-bezier(x1, y1, x2, y2) | 使用三阶贝塞尔函数中自定义 transition 变化过程，函数的参数值必须处于 0 到 1 之间。更多关于三次贝塞尔的信息请参阅 [cubic-bezier](http://cubic-bezier.com/)<br/> 和 [Bézier curve](https://en.wikipedia.org/wiki/B%C3%A9zier_curve)<br/>. |
...
> 更新: 2022-02-15 18:59:02  
> 原文: <https://www.yuque.com/wcye0k/haasui/wlmgk4>