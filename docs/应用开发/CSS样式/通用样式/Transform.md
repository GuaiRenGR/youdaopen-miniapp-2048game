...
在 native 端，给组件设置 `transform` 变换后，如果需要恢复原效果，不能直接删除对应的 `transform` 属性，而需要重新设置一个 `transform` 将元素变换恢复。可对比以下两个示例(<font style="color:#E8323C;">待提供</font>)


> 更新: 2022-02-15 18:55:13  
> 原文: <https://www.yuque.com/wcye0k/haasui/zcgtb7>